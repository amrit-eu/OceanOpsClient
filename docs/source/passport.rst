...
Below is a full example of the JSON passport for the OceanOps push API.
It is based on the schema: https://www.ocean-ops.org/passports/examples/a-passport-input.schema.json
